        ...
        <div className="p-8 rounded-lg shadow-lg w-full max-w-3xl text-white">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6 " onSubmit={handleCreate}>
            <div className="col-span-2 sm:col-span-1">
              <input type="text" name="firstname" placeholder="Nombre" value={formData.firstname} onChange={handleChange} className="mt-1 bg-white text-black block w-full p-2 border border-gray-300 rounded-md sm:bg-blue" />
            </div>
            <div className="col-span-2 sm:col-span-1">
